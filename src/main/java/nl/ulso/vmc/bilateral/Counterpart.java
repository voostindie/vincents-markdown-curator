...
///
/// The default recurrence of a bilateral meeting is [#DEFAULT_RECURRENCE_IN_DAYS]. If the value of
/// the [#BILATERAL_PROPERTY] can be parsed as an integer, that value is used instead, as a number
/// of days between meetings.
public record Counterpart(Document document, int recurrenceInDays)
    implements Comparable<Counterpart>
{
    ...
    @Override
    public int compareTo(Counterpart other)
    {
