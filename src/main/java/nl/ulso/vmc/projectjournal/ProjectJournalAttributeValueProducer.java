...
/// Base class for change processors that produce values for a specific project attribute
/// definition from daily entries in the journal.
///
    ...
    implements MeasurementTracker
{
    ...
    // Forces a complete reload of all attribute values tracked by this producer.
